...
def main():
    ...
    try:
        ...
        # Parse timestamps
        print("\n[PROCESS] Parsing timestamps and extracting features...")
        ...
        print("[PROCESS] Calculating reply gaps...")
        ...
        print(f"[OK] Calculated {df['reply_gap_minutes'].notna().sum()} reply gaps")
        
        # Per-person metrics
        print("\n[ANALYSIS] Computing per-person metrics...")
        ...
        print("[ANALYSIS] Analyzing daily initiative...")
